...
class PaymentMethod(models.Model):
    ...
    activity = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="payments_activities",
    )
...
class Tarifa(TimeStampedModel):
    ...
    activity = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="tarifas_activities",
    )
...
class InscriptionGroup(TimeStampedModel):
    ...
    activity = models.ForeignKey(
        "activity.Activity", models.CASCADE, related_name="fk_InscriptionGroupActivity"
    )
    user = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="fk_InscriptionGroupUser",
    )
    paymentmethod = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="fk_InscriptionGroupMethod",
    )
    tarifa = models.ForeignKey(
        ...
        blank=True,
        null=True,
        related_name="fk_InscriptionGroupTarifa",
    )
    ...
    def __str__(self):
        return f"{self.vouchergroup} - {self.activity.description}"
...
class Inscription(TimeStampedModel):
    ...
    person = models.ForeignKey(
        "person.Person", models.CASCADE, related_name="fk_InscriptionPerson"
    )
